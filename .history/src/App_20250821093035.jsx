...
import { Plus, Volleyball, Upload, Database, Calendar, Users, Trophy, Save, Edit3, Trash2, RefreshCcw, LogIn, LogOut, Lock, Share2, X } from "lucide-react";
      ...
      {isMobile && selectedMatch && (
        <div className="fixed bottom-0 inset-x-0 border-t bg-white/95 backdrop-blur p-3 pt-2" style={{ paddingBottom: 'max(env(safe-area-inset-bottom), 12px)' }}>
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              {(() => {
                const active = getActiveSet(selectedMatch.sets);
